...
# --- 1. Calculations for Mu-sweep (Left Column) ---
...
with col2:
    ...
    # Calculate current state and extract as scalar
    _, current_s_arr = calculate_physics(T_user, U_user, mu_fixed)
    current_s_val = current_s_arr.item() 
    
    # Highlight current selection
    ax3.scatter([T_user], [current_s_val], color='black', s=80, edgecolors='white', zorder=5, label='Current State')
